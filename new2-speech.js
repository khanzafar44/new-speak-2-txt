...
function l() {
    K.html(
        V.speaking
            ? 'Stop &nbsp; <img src="../images/mic-animate.gif" height="44">'
            : "Speak"
    );
}
...
function b(e) {
    te && ((e = e.charAt(0).toUpperCase() + e.substr(1)), (te = !1)),
        m(" " + e);
}
function w() {
    ue &&
        ...
        ue.addCallback("error", function (e) {
            ...
            switch (e.error) {
                ...
                case "no-speech":
                    t = C()
                        ? ""
                        : "ðŸ Click the microphone to restart dictation";
                    break;
                case "network":
                    t =
                        "ðŸ‘¨ðŸ¼â€ðŸ’» Please check whether your computer is connected to the Internet or not?";
                    break;
                case "audio-capture":
                    t =
                        "Sorry. can't hear you properly. Is your microphone turned on? If you're experiencing issues, try moving to a quieter place or using an external microphone.";
                    break;
                case "not-allowed":
                ...
                default:
                    t =
                        "ðŸ‘¨ðŸ¼â€ðŸ’» Please ensure that no other tab in your browser is using the microphone else Dictation may not work.";
            }
            L(t), j();
        }),
...
function j() {
    (se = se || $("img.bars")),
        C()
            ? se.attr("src", "https://blogger.googleusercontent.com/img/a/AVvXsEj1OeHNCzeBE64x6xEaelJyD0LWOwg_4wAJnA6xjAAAwPFhxwEpmhD3e5odUiHEHPMO2lZ4cMTxp2SmMptCWDYWXxV0COkyqPtHsuvhqD3XqBkX9hOQjr4qnBytLly7pfBqfThpRjbpTZd6jPsYsYh1B1PtpFP0nc9NP36R23V8hqAxGO8FRwckkzYbLV0")
            : se.attr("src", "https://blogger.googleusercontent.com/img/a/AVvXsEjCCNhGpKJEeieh8CjlazbLHFc8Xd_a_c-bZDsmGnnInYx28Ve8GyyraReEELzc9iawn2ov4PGemnQVaI72VEiEqm1eAa0hmfyKDvlwfuNpRY7ocyB4mfzjAKSSrFmA6DRmCEchS-LsBsPVmmi-ejUa2vOJGmf80_RC4ergINm_3hfMjLcgKiJJsNjmKvI");
}
function T() {
    ue && ue.abort();
}
...
function z() {
    ue
        ? (C() ? T() : (ne && ((ne = !1), u()), ue.resume(), L("I'm Listening...")),
          N())
        : q();
}
function A() {
    ...
    if (
        ...
        var e = 0,
            t = [
                ...
                "\n\n",
                "Please open oktyping.com inside ",
                "Google Chrome ",
                ...
                "\n\n",
                "For assistance, ",
                "please email khanzafar44@gmail.com",
                "\n",
                "Thanks!"
            ],
    ...
    if (
        ...
        var t = 0,
            n = [
                ...
                "\n\n",
                "Note:",
                "Click on the Mic icon above and Start Speak....",
...
function H() {
    return '<style>body{font:12pt Georgia,"Times New Roman",Times,serif;line-height:1.3;}body:after{font-style:italic;content:"This document was printed from oktyping.com";}p a{word-wrap: break-word;}a{color: #000;}p a:after{content: " (" attr(href) ")";font-size: 80%;}</style>';
}
function M() {
    var e = window.open("");
...
!(function (e, t) {
    ...
    function b(e, t, n, i, o) {
        ...
        for (p.textContent = "", h = 0; (a = f[h++]); )
            if (i && -1 < he.inArray(a, i)) o && o.push(a);
                ...
                ((u = Ie(a)), (s = y(p.appendChild(a), "script")), u && k(s), n)
            )
    ...
    function A(e, t, r, i) {
        ...
        if (
            g ||
            (1 < p && "string" == typeof h && !le.checkClone && et.test(h))
        )
        ...
        if (
            ...
            if (l)
                for (
                    u = s[s.length - 1].ownerDocument, he.map(s, _), d = 0;
                    d < l;
                    d++
                )
                    (c = s[d]),
    ...
    function F(e, t, n) {
        ...
        for (
            ...
            if ((r = F.prefilters[o].call(c, e, u, c.opts)))
                return (
                    ce(r.stop) &&
                        (he._queueHooks(c.elem, c.opts.queue).stop =
                            r.stop.bind(r)),
                    r
                );
        return (
            ...
            he.fx.timer(
                he.extend(l, { elem: e, anim: c, queue: c.opts.queue })
            ),
            c
        );
    }
    ...
    var ge = (function (e) {
            ...
            if (!r && (_(t), (t = t || z), N)) {
                ...
                if (
                    ...
                    if (
                        ...
                        for (
                            ((f = (me.test(e) && c(t.parentNode)) || t) === t &&
                                y.scope) ||
                                ((s = t.getAttribute("id"))
                                    ? (s = s.replace(ke, be))
        ...
        function m(e) {
            for (
                ...
                if ((n = k.relative[e[s].type])) u = [p(f(u), n)];
                    ...
                    if (
                        (n = k.filter[e[s].type].apply(null, e[s].matches))[q]
                    ) {
                            ...
                            (i(function (e) {
                                ...
                                (A.appendChild(e).innerHTML =
                                    ...
                                    e.querySelectorAll("[id~=" + q + "-]")
                                        .length || L.push("~="),
                                    (t = z.createElement("input")).setAttribute(
                                        "name",
                                        ""
                                    ),
                                    e.appendChild(t),
        ...
        (t.attr = function (e, t) {
            ...
            var n = k.attrHandle[t.toLowerCase()],
                r =
                    n && W.call(k.attrHandle, t.toLowerCase())
                        ? n(e, t, !N)
                        : void 0;
            return void 0 !== r
                ? r
        ...
        return (
            ...
            (y.sortDetached = i(function (e) {
                return (
                    1 & e.compareDocumentPosition(z.createElement("fieldset"))
                );
            })),
            i(function (e) {
                return (
    ...
    (he.event = {
                            ...
                            (u = he.extend(
                                {
                                    ...
                                    selector: i,
                                    needsContext:
                                        i && he.expr.match.needsContext.test(i),
                                    namespace: h.join(".")
                                },
                                o
                            )),
        ...
        dispatch: function (e) {
            var t,
                ...
                l = he.event.fix(e),
                c =
                    (Ne.get(this, "events") || Object.create(null))[l.type] ||
                    [],
    ...
    he.extend({
        ...
        clone: function (e, t, n) {
            ...
            return (
                0 < (a = y(u, "script")).length && k(a, !d && y(e, "script")), u
            );
        },
    ...
    (he.Animation = he.extend(F, {
        ...
        (mt = de
            ...
            .appendChild(de.createElement("option"))),
        (gt.type = "checkbox"),
        (le.checkOn = "" !== gt.value),
                ...
                select: {
                    ...
                    set: function (e, t) {
                        for (
                            ...
                            ((r = i[a]).selected =
                                -1 <
                                he.inArray(he.valHooks.option.get(r), o)) &&
                                (n = !0);
            ...
            if (
                ...
                for (o = 0; (a = f[o++]) && !t.isPropagationStopped(); )
                    (p = a),
                        ...
                        (u =
                            (Ne.get(a, "events") || Object.create(null))[
                                t.type
                    ...
                    i ||
                        ...
                        (c &&
                            ...
                            t.isPropagationStopped() &&
                                p.addEventListener(h, Tt),
                            r[h](),
                            t.isPropagationStopped() &&
                                p.removeEventListener(h, Tt),
            ...
            ajax: function (t, n) {
                function r(t, n, r, s) {
                    ...
                    u ||
                        ...
                        (C.statusText = (n || x) + ""),
                        c
                            ? v.resolveWith(g, [p, x, C])
                            : v.rejectWith(g, [C, x, f]),
                        C.statusCode(k),
                        (k = void 0),
                        d &&
            ...
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  t ||
                      (le.createHTMLDocument
                          ? (((r = (t =
                                de.implementation.createHTMLDocument(
                                    ""
...
!(function (e, t) {
    ...
    "function" == typeof define && define.amd
        ...
        : "object" ===
              ("undefined" == typeof module ? "undefined" : G(module)) &&
          module.exports
        ? (module.exports = t(e))
        : (e.annyang = t(e));
    ...
    return (n = {
        init: function (f) {
            var h =
                !(arguments.length > 1 && arguments[1] !== t) || arguments[1];
            i && i.abort && i.abort(),
                ...
                (i.onresult = function (e) {
                    if (d)
                        return (
                            u && w("Speech heard, but annyang is paused"), !1
                        );
                    for (
        ...
        debug: function () {
            var e =
                !(arguments.length > 0 && arguments[0] !== t) || arguments[0];
            u = !!e;
        },
...
(window.mr = window.mr || {}),
    (mr = (function (e, t, n, r) {
        ...
        function i(n) {
            (n = void 0 === n ? t : n),
                a.documentReady
                    .concat(a.documentReadyDeferred)
                    .forEach(function (e) {
                        e(n);
                    }),
    ...
    (mr = (function (e, t, n, r) {
        ...
        return (
            ...
            (e.util.idleSrc = function (e, n) {
                (n = void 0 !== n ? n : ""),
                    (e.is(n + "[src]") ? e : e.find(n + "[src]")).each(
                        function (e, n) {
                            var r = (n = t(n)).attr("src");
                            void 0 === n.attr("data-src") &&
                                n.attr("data-src", r),
                                n.attr("src", "");
                        }
                    );
    ...
    (mr = (function (e, t, n) {
                ...
                return (
                    t
                        ...
                        .forEach(function (n) {
                            ...
                            if (
                                2 ===
                                (r = n.replace(/\s/g, "").split(":")).length
                            ) {
                                if (!((i = e.util.parsePixels(r[0])) > -1))
                                    return !1;
                                if (((o.scrollPoint = i), !r[1].length))
                                    return !1;
                                var a = r[1];
                                (o.toggleClass = a),
            ...
            (e.scroll.classModifiers.update = function (t) {
                for (
                    ...
                    r > (n = i[o]).scrollPoint &&
                        ...
                        (n.hasClass = e.scroll.classModifiers.rules[
                            o
                        ].hasClass =
                            !0)),
                        r < n.scrollPoint &&
        ...
        var r = function () {
                t('.main-container [data-scroll-class*="pos-fixed"]').each(
                    function () {
                        var e = t(this);
                    ...
                    jQuery(r).on(
                        ...
                        function () {
                            t(
                                ...
                                e.accordions.activatePanelById(
                                    t(this).attr("href"),
                                    !0
                                );
                        }
            ...
            (e.dropdowns.documentReady = function (t) {
                ...
                t('html[dir="rtl"]').length && (i = !0),
                    e.dropdowns.done ||
                        ...
                        jQuery("body.dropdowns--hover .dropdown").on(
                            "click",
                            function (e) {
                                e.stopPropagation(),
            ...
            (e.dropdowns.repositionDropdowns = function (e) {
                e(".dropdown__container").each(function () {
                    ...
                    jQuery(this).css("left", ""),
                        ...
                        e.css("left", -t + n),
                        e.find('.dropdown__content:not([class*="md-12"])')
                            .length &&
        ...
        return (
                    ...
                    t("[data-notification-link]:not(.notification)").on(
                        ...
                        function () {
                            var n = jQuery(this).attr("data-notification-link"),
                                r = t(
                                    '.notification[data-notification-link="' +
                                        n +
                                        '"]'
                                );
                            return (
            ...
            (e.notifications.showNotification = function (t, n) {
                ...
                if (
                    (setTimeout(function () {
                        a.initEvent(
                            "notificationOpened.notifications.mr",
                            !0,
                            !0
                        ),
                            i
            ...
            (e.smoothscroll.highlight = function () {
                e.smoothscroll.sections.forEach(function (t) {
                    e.scroll.y >= t.top && e.scroll.y < t.top + t.height
                        ? !1 === t.active &&
                          (t.link.classList.add("inner-link--active"),
                          (t.active = !0))
                        : (t.link.classList.remove("inner-link--active"),
                          (t.active = !1));
                });
            }),
                    ...
                    o.length &&
                        (o.each(function (e) {
                            ...
                            "#" !== n.attr("href").charAt(0) &&
                                n.removeClass("inner-link");
                        }),
                        e.smoothscroll.init(),
                        t(n).on("resize", e.smoothscroll.init),
                        (r = 0),
                        t("body[data-smooth-scroll-offset]").length &&
                            ((r = t("body").attr("data-smooth-scroll-offset")),
                            (r *= 1)),
                        (a.offset = 0 !== r ? r : void 0),
                        smoothScroll.init(
                            jQuery.extend({}, i, e.smoothscroll.options, a)
                        ));
            }),
        ...
        return (
            ...
            (e.tabs.documentReady = function (t) {
                t(".tabs").each(function () {
                    ...
                    "" !== n.location.hash &&
                        e.tabs.activateTabById(n.location.hash),
                ...
                t(".youtube-background").length &&
                    ...
                    t(".video-cover").each(function () {
                        ...
                        e.find("iframe[src]").length &&
                            (e
                                .find("iframe")
                                .attr("data-src", e.find("iframe").attr("src")),
        ...
        dictation: {
            ...
            callback: function (e) {
                "go to sleep" === (e = (e || "").toLowerCase().trim())
                    ? ue.pause()
                    : -1 !==
                      ["wake up", "start", "begin", "microphone on"].indexOf(e)
                    ? ue.resume()
                    : ue.abort();
            }
        },
